...
namespace Iepure_Paul_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Iepure_Paul_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Iepure_Paul_Lab8Context context,
